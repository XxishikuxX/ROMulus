        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500 via-cyan-600 to-orange-500 flex items-center justify-center shadow-lg shadow-cyan-500/30">
      ...
      <div className="flex-1 lg:max-w-xl flex items-center justify-center p-6 lg:p-12">
        ...
        >
          ...
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            ...
            <span className="text-2xl font-bold">EmuVerse</span>
          </div>
          ...
          <div className="mt-6 p-4 bg-cyan-500/10 border border-cyan-500/20 rounded-xl">
            ...
            <p className="text-xs text-gray-400">
              Email: demo@emuverse.io • Password: demo123
            </p>
          </div>
        </motion.div>
      </div>
