      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-white/[0.04]">
          <NavLink to="/" className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 via-cyan-600 to-orange-500 flex items-center justify-center shadow-lg shadow-cyan-500/30">
            ...
            >
              <div className="h-16 flex items-center justify-between px-4 border-b border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xl font-bold">EmuVerse</span>
                </div>
                <button
                  onClick={() => setMobileMenuOpen(false)}
