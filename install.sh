#!/bin/bash
# ===========================================
# EmuVerse Quick Installer
# ===========================================
# Usage: curl -fsSL https://raw.githubusercontent.com/yourusername/emuverse/main/install.sh | bash
# Or: wget -qO- https://raw.githubusercontent.com/yourusername/emuverse/main/install.sh | bash
# ===========================================
...
# Configuration
REPO_URL="https://github.com/yourusername/emuverse.git"
INSTALL_DIR="/opt/emuverse"
DATA_DIR="/opt/emuverse/data"

# Print banner
echo -e "${CYAN}"
cat << "EOF"
    ______                 _    __                    
   / ____/___ ___  __  __ | |  / /__  _____________ 
  / __/ / __ `__ \/ / / / | | / / _ \/ ___/ ___/ _ \
 / /___/ / / / / / /_/ /  | |/ /  __/ /  (__  )  __/
/_____/_/ /_/ /_/\__,_/   |___/\___/_/  /____/\___/ 
                                                     
EOF
echo -e "${NC}"
echo -e "${GREEN}EmuVerse Installer v2.2${NC}"
echo "========================================"
echo ""
...
clone_repo() {
    echo ""
    echo "Cloning EmuVerse repository..."
...
create_directories() {
    ...
    sudo mkdir -p /opt/emuverse/logs
    
    sudo chown -R $USER:$USER "$DATA_DIR"
    sudo chown -R $USER:$USER /opt/emuverse/logs
...
start_services() {
    echo ""
    echo "Starting EmuVerse services..."
...
print_success() {
    echo ""
    echo -e "${GREEN}========================================"
    echo "  EmuVerse Installation Complete! 🎮"
    echo "========================================${NC}"
    echo ""
    echo "Access EmuVerse at:"
    echo -e "  ${CYAN}http://localhost${NC}"
    echo ""
    echo "Default admin credentials:"
    echo -e "  Email:    ${CYAN}admin@emuverse.local${NC}"
    ...
    echo ""
    echo "Documentation: https://github.com/yourusername/emuverse#readme"
    echo ""
}
