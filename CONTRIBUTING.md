...
Thank you for your interest in contributing to ROMulus! This document provides guidelines and instructions for contributing.
...
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/XxishikuxX/ROMulus.git
   ```
